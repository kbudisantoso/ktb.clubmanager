...
describe("MyClubsPage", () => {
  ...
  describe("leave club", () => {
    ...
    it("disables confirm button until VERLASSEN is typed", async () => {
      ...
      const confirmButton = dialog.querySelector('button[data-variant="destructive"]') as HTMLButtonElement;
    ...
    it("shows error toast when leaving fails", async () => {
      ...
      mockLeaveMutate.mockImplementation((_slug: string, options: { onError: (error: Error) => void }) => {
